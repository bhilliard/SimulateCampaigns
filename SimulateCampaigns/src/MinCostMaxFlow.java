...
public class MinCostMaxFlow {
	...
	public static void main (String args[]){
		...
		int[][] flowSolution = flow.getMaxFlow(cap, cost1, 0, 4);
		//System.out.println (ret1[0] + " " + ret1[1]);
		//System.out.println (ret2[0] + " " + ret2[1]);
		for(int i=0;i<flowSolution.length;i++){
			for(int j=0;j<flowSolution[0].length;j++){
				System.out.print(flowSolution[i][j]+" ");
			}
			System.out.println();
		}
